...
//        }
    ...
    protected void info(String msg) {
        mMessager.printMessage(Diagnostic.Kind.OTHER, "✅ [ExtJSBridge-AnnotationProcess] " + msg);
    }

    protected void error(String msg) {
        mMessager.printMessage(Diagnostic.Kind.ERROR, "❎ [ExtJSBridge-AnnotationProcess] " + msg);
    }
}
