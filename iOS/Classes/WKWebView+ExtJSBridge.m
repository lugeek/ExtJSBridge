...
- (ExtJSWebViewBridge *)ext_bridge {
    return objc_getAssociatedObject(self, "ext_bridge");
}

- (void)ext_setBridge:(ExtJSWebViewBridge *)bridge {
...
- (void)ext_initializeBridgeWithName:(NSString *)name {
    @synchronized (self) {
        ...
        ExtJSWebViewBridge *bridge = [[ExtJSWebViewBridge alloc] initWithName:name webView:self];
